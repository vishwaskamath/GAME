...
sound1[0] = "../assets/audio/1-1.mp3";
sound1[1] = "../assets/audio/1-2.mp3";
sound1[2] = "../assets/audio/1-3.mp3";
function getSound1() {
...
sound2[0] = "../assets/audio/2-1.mp3";
sound2[1] = "../assets/audio/2-2.mp3";
sound2[2] = "../assets/audio/2-3.mp3";
function getSound2() {
...
sound3[0] = "../assets/audio/3-1.mp3";
sound3[1] = "../assets/audio/3-2.mp3";
sound3[2] = "../assets/audio/3-3.mp3";
function getSound3() {
...
sound4[0] = "../assets/audio/4-1.mp3";
sound4[1] = "../assets/audio/4-2.mp3";
sound4[2] = "../assets/audio/4-3.mp3";
function getSound4() {
...
sound5[0] = "../assets/audio/5-1.mp3";
sound5[1] = "../assets/audio/Cymbal.mp3";
sound5[2] = "../assets/audio/Cymbal.mp3";
function getSound5() {
...
sound6[0] = "../assets/audio/6-1.mp3";
sound6[1] = "../assets/audio/6-2.mp3";
sound6[2] = "../assets/audio/6-3.mp3";
function getSound6() {
...
function one() {
    ...
    if (cchoice === 1) {
        ...
        window.location.href = "../cchase.html";
        localStorage.setItem("ptarget", total);
    }
    else {
